...
package com.willshex.blogwt.shared.util;
...
import com.willshex.blogwt.shared.util.ContainerHelpers.ArrayIterator;
 ...
 */
public class LongSparseArray<E> implements /* Cloneable */ Iterable<E> {
	...
	public LongSparseArray (int initialCapacity) {
		if (initialCapacity == 0) {
			...
			initialCapacity = ContainerHelpers
					.idealLongArraySize(initialCapacity);
	...
	public Iterator<E> iterator () {
		return new ArrayIterator<E>((E[]) mValues, size());
	}
	...
	public static <E> LongSparseArray<E> of (Iterable<E> i,
			Function<E, Long> p) {
		LongSparseArray<E> array = null;

		if (i != null && p != null) {
			final LongSparseArray<E> a = new LongSparseArray<>();
			i.forEach(s -> a.put(p.apply(s).longValue(), s));
			array = a;
		}
	...
	public void putAll (Iterable<E> i, Function<E, Long> p) {
		i.forEach(s -> put(p.apply(s).longValue(), s));
	}
