// 
//  UpdateMetaNotificationResponse.java
//  blogwt
// 
...
public class UpdateMetaNotificationResponse extends Response {
	...
	/**
	  ...
	  * @return
	  */
	public UpdateMetaNotificationResponse meta (MetaNotification meta) {
		this.meta = meta;
		return this;
	}
}