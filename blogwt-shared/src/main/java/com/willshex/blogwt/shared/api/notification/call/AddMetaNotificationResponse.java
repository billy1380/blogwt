// 
//  AddMetaNotificationResponse.java
//  blogwt
// 
...
public class AddMetaNotificationResponse extends Response {
	...
	/**
	  ...
	  * @return
	  */
	public AddMetaNotificationResponse meta (MetaNotification meta) {
		this.meta = meta;
		return this;
	}
}