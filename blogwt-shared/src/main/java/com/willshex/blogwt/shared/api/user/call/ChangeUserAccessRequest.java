...
public class ChangeUserAccessRequest extends Request {
	...
	public JsonObject toJson () {
		...
		JsonElement jsonRevoke = revoke == null ? JsonNull.INSTANCE
				: new JsonPrimitive(revoke);
		object.add("revoke", jsonRevoke);
		JsonElement jsonSuspend = suspend == null ? JsonNull.INSTANCE
				: new JsonPrimitive(suspend);
		object.add("suspend", jsonSuspend);
	...
	public ChangeUserAccessRequest user (User user) {
		this.user = user;
		return this;
	}

	public ChangeUserAccessRequest roles (List<Role> roles) {
		this.roles = roles;
		return this;
	}

	public ChangeUserAccessRequest permissions (List<Permission> permissions) {
		this.permissions = permissions;
		return this;
	}

	public ChangeUserAccessRequest revoke (Boolean revoke) {
		this.revoke = revoke;
		return this;
	}

	public ChangeUserAccessRequest suspend (Boolean suspend) {
		this.suspend = suspend;
		return this;
	}

	public ChangeUserAccessRequest suspendUntil (Date suspendUntil) {
