// 
//  GetMetaNotificationResponse.java
//  blogwt
// 
...
public class GetMetaNotificationResponse extends Response {
	...
	/**
	  ...
	  * @return
	  */
	public GetMetaNotificationResponse meta (MetaNotification meta) {
		this.meta = meta;
		return this;
	}
}