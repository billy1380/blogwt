...
public enum SortDirectionType {
	...
	public static SortDirectionType fromString (String value) {
		if (valueLookup == null) {
			...
			for (SortDirectionType currentSortDirectionType : SortDirectionType
					.values()) {
				valueLookup.put(currentSortDirectionType.value,
						currentSortDirectionType);
			}
		}
		return valueLookup.get(value);
	}

	public SortDirectionType reverse () {
		return this == SortDirectionTypeAscending ? SortDirectionTypeDescending
