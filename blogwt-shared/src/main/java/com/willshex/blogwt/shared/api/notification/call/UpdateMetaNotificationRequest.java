// 
//  UpdateMetaNotificationRequest.java
//  blogwt
// 
...
public class UpdateMetaNotificationRequest extends Request {
	...
	/**
	  ...
	  * @return
	  */
	public UpdateMetaNotificationRequest meta (MetaNotification meta) {
		this.meta = meta;
		return this;
	}
}