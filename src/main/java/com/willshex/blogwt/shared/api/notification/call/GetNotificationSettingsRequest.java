// 
//  GetNotificationSettingsRequest.java
//  blogwt
// 
...
public class GetNotificationSettingsRequest extends Request {
	public User user;
	public Pager pager;
	...
	public GetNotificationSettingsRequest user (User user) {
		this.user = user;
		return this;
	}

	public GetNotificationSettingsRequest pager (Pager pager) {
		this.pager = pager;
		return this;
	}
}